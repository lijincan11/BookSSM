...
<body class="body_login">
   ...
   <div class="login_c">
        ...
        <div class="login_c_right">
             <dl>
                  <dt>账&nbsp;&nbsp;&nbsp;号：</dt>
                  <dd><input name="username" type="text"  class="username"/></dd>
             </dl>
             <dl>
                  <dt>密&nbsp;&nbsp;&nbsp;码：</dt>
             ...
             <dl>
                 ...
                 <div class="form-group">
                        <label class="checkbox">
                        	<input name="yzm" type="text"  class="yzm_txt"/>
                            <img class="center-block" alt="看不清，点击换图" id="imgId" src="${APP_PATH }/code.action" onclick="changeImg()" title="点击切换"/>
                            <p id="" style="text-align: center">${msg }${codeMsg }</p>
                        </label>
                    </div>
             </dl>
             <div class="login_butt">
                   <input type="submit" class="bts"  value="登陆"/>
                   <input name="qx" type="button" class="bts"  value="取消"/>
             </div>
             <div class="login_zc">
                  <a href="" target="_blank" class="login_zc1">忘记登陆密码</a>
...
//	点击切换验证码
	function changeImg() {
		document.getElementById("imgId").src="${APP_PATH}/code.action?"+new Date().getTime();
	};
