         ...
         <div class="warp">
               ...
               <div class="nav_right">
                    <ul>                                                       
                         ...
                         <li><a href="">我的订单</a></li>
                         <li><a href="user_11.jsp">个人中心</a></li>
                         <li><a href="">客户服务</a></li>
                    </ul>
               </div>
         </div>
...
<div class="container">
     ...
     <div class="con_one">
          ...
          <div class="con_one_left">
               ...
               <div class="hotsell">
                    ...
                    <div class="hotsell_b">
                         <ul>
                                <li>
                                  <div class="dis_pi"><a href="" target="_blank"><img src="${APP_PATH}/images/book4.jpg" width="70" height="82"  alt="" title=""/></a> <span class="pic_r"><em>火车头</em> <i>￥23.80</i> <del>￥39.00 </del> </span> </div>
			  ...
			  jQuery(".hotsell_b").slide({ titCell:"li",triggerTime:0 });
               ...
               <div class="ads1">
                   <ul>
                       <li><a href=""><img src="${APP_PATH}/images/ad1.jpg" width="235" height="115" /></a></li>
                       <li><a href=""><img src="${APP_PATH}/images/ad2.jpg" width="235" height="115" /></a></li>
                   </ul>
               </div>
               <!--ads1 end -->
          </div>
          ...
          <div class="con_one_right">
               ...
               <div class="banner">
                   <ul class="pic">
					<li><a href="" target="_blank"><img src="${APP_PATH}/images/banner1.jpg" width="856" height="335" /></a></li>
					<li><a href="" target="_blank"><img src="${APP_PATH}/images/banner2.jpg" width="856" height="335" /></a></li>
					<li><a href="" target="_blank"><img src="${APP_PATH}/images/banner3.jpg" width="856" height="335" /></a></li>
					<li><a href="" target="_blank"><img src="${APP_PATH}/images/banner4.jpg" width="856" height="335" /></a></li>
                  </ul>
                  <ul class="hd">
                      <li></li>
                      <li></li>
               ...
               <div class="newbook">
                    ...
                    <div class="bd">
                        <ul>
                           ...
                           <li>
                              <a href="detail.action?bookid=${book.bookid }" target="_blank">
                                   <div class="imgs"><img src="${APP_PATH}/${book.bookimg }" width="135" height="157" alt="" title=""/></div>
                                   <h3>${book.bookname }</h3>
                                   <div class="shou">
                                        <span class="shou_l">已售：<b class="red">${book.sent }</b></span>
               ...
               <div class="hottj">
                    ...
                    <div class="bd">
                          ...
                          <li class="last">
                              <a href="detail.action?bookid=${book1.bookid }" target="_blank">
                                   <div class="imgs"><img src="${book1.bookimg }" width="132" height="180" alt="" title=""/></div>
                                   <h3>${book1.bookname }</h3>
                                   <div class="shou">
                                        <span class="shou_l">已售：<b class="red">${book1.sent }</b></span>
                                        <span class="shou_r">收藏：<b class="red">19</b></span>
                                   </div>
                                   <div class="price">￥${book1.bookprice }</div>
                              </a>
                            </li>
                           </c:forEach>
                          </ul>
                          ...
                          <ul class="tjul">
                          <c:forEach var="book2" items="${book2 }">
                            <li class="last">
                              <a href="detail.action?bookid=${book2.bookid }" target="_blank">
                                   <div class="imgs"><img src="${book2.bookimg }" width="132" height="180" alt="" title=""/></div>
                                   <h3>${book2.bookname }</h3>
                                   <div class="shou">
                                        <span class="shou_l">已售：<b class="red">${book2.sent }</b></span>
                                        <span class="shou_r">收藏：<b class="red">19</b></span>
                                   </div>
                                   <div class="price">￥${book2.bookprice }</div>
                              </a>
                            </li>
                            </c:forEach>
                          </ul>
                          ...
                          <ul class="tjul">
                           <c:forEach var="book3" items="${book3 }">
                            <li class="last">
                              <a href="detail.action?bookid=${book3.bookid }" target="_blank">
                                   <div class="imgs"><img src="${book3.bookimg }" width="132" height="180" alt="" title=""/></div>
                                   <h3>${book3.bookname }</h3>
                                   <div class="shou">
                                        <span class="shou_l">已售：<b class="red">${book3.sent }</b></span>
                                        <span class="shou_r">收藏：<b class="red">19</b></span>
                                   </div>
                                   <div class="price">￥${book3.bookprice }</div>
                              </a>
                            </li>
                            </c:forEach>
                          </ul>
                          ...
                          <ul class="tjul">
                          	<c:forEach var="book4" items="${book4 }">
                            <li class="last">
                              <a href="detail.action?bookid=${book4.bookid }" target="_blank">
                                   <div class="imgs"><img src="${book4.bookimg }" width="132" height="180" alt="" title=""/></div>
                                   <h3>${book4.bookname }</h3>
                                   <div class="shou">
                                        <span class="shou_l">已售：<b class="red">${book4.sent }</b></span>
                                        <span class="shou_r">收藏：<b class="red">19</b></span>
                                   </div>
                                   <div class="price">￥${book4.bookprice }</div>
                              </a>
                            </li>
                            </c:forEach>
                          </ul>
                          ...
                          <ul class="tjul">
                           <c:forEach var="book5" items="${book5 }">
                            <li class="last">
                              <a href="detail.action?bookid=${book5.bookid }" target="_blank">
                                   <div class="imgs"><img src="${book5.bookimg }" width="132" height="180" alt="" title=""/></div>
                                   <h3>${book5.bookname }</h3>
                                   <div class="shou">
                                        <span class="shou_l">已售：<b class="red">${book5.sent }</b></span>
                                        <span class="shou_r">收藏：<b class="red">19</b></span>
                                   </div>
                                   <div class="price">￥${book5.bookprice }</div>
                              </a>
                            </li>
                            </c:forEach>
                          </ul>
                          ...
                          <ul class="tjul">
                            <c:forEach var="book6" items="${book6 }">
                            <li class="last">
                              <a href="detail.action?bookid=${book6.bookid }" target="_blank">
                                   <div class="imgs"><img src="${book6.bookimg }" width="132" height="180" alt="" title=""/></div>
                                   <h3>${book6.bookname }</h3>
                                   <div class="shou">
                                        <span class="shou_l">已售：<b class="red">${book6.sent }</b></span>
                                        <span class="shou_r">收藏：<b class="red">19</b></span>
                                   </div>
                                   <div class="price">￥${book6.bookprice }</div>
                              </a>
                            </li>
                            </c:forEach>
                          </ul>
